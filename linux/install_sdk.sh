...
sdk install java 12.0.2-zulu < /dev/null
sdk default java 12.0.2-zulu || exit 1

sdk install java 11.0.2-open < /dev/null
sdk default java 11.0.2-open || exit 1

sdk install java 11.0.4-zulu < /dev/null
sdk default java 11.0.4-zulu || exit 1
...
sdk install java 8.0.222-zulu < /dev/null
sdk default java 8.0.222-zulu || exit 1

sdk install java 6.0.119-zulu < /dev/null
sdk default java 6.0.119-zulu || exit 1

sdk default java 12.0.2-zulu
